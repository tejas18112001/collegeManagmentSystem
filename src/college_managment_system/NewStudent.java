...
public class NewStudent extends JFrame implements ActionListener {
    ...
    NewStudent() {
        ...
        setLayout(null) ;
        JLabel label = new JLabel("New Student Detail") ;
        ...
        rollno.setBounds(30 ,170 ,80 ,20) ;
        rollno.setFont(new Font("Tahoma" , Font.PLAIN , 15)) ;
        add(rollno) ;
        
        rollnoInput = new JLabel("2201" + randomRoll) ;
        rollnoInput.setBounds(120 ,170 , 250 , 25) ;
      ...
      public void actionPerformed(ActionEvent e) {
           if(e.getSource() == submit) {
              ...
              try{
                 ...
                 String query = "insert into student values('"+sn+"', '"+fn+"', '"+rollno+"', '"+dob+"', '"+ad+"', '"+ph+"', '"+em+"', '"+m1+"', '"+m2+"', '"+adhar+"', '"+Course+"', '"+Branch+"')";
                 Conn c = new Conn() ;
